...
/** @brief
  cockroachdb_SHARE is a structure that will be shared among all open handlers.
  This example implements the minimum of what you will probably need.

//TODO: join this with RDBSE_TABLE_DEF ?
*/
typedef struct st_cockroachdb_share {
    char *table_name;
...
class ha_cockroachdb: public handler
{
    ...
    */
    ...
    void setup_index_scan(cockroachdb::Slice *slice);
    ...
    public:
    ha_cockroachdb(handlerton *hton, TABLE_SHARE *table_arg);
    ~ha_cockroachdb() {}

    /** @brief
      The name that will be used for display purposes.
      */
    const char *table_type() const { return "cockroachdb"; }
    ...
    void convert_record_from_storage_format(cockroachdb::Slice *slice, uchar *buf);
    void convert_record_from_storage_format(uchar *buf);

    void convert_record_to_storage_format(cockroachdb::Slice *packed_rec);
